...
<br>
• Explore audio representations in the time domain and in the time-frequency domain, you will learn to extract audio features relevant for machine hearing models, You will learn to pre-process audio, to extract relevant audio features, to train a ResNet-18 model on an environmental sound classification task and to evaluate the performance of the trained model.
